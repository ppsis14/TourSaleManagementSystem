...
public class ReserveEditPageController implements Initializable {
    ...
    @FXML private ChoiceBox<String> tourCodeChoiceED;
    ...
    public ReserveEditPageController(String reserveID) {
        this.reserveID = reserveID;
    }

    @FXML
    public void handleUpdateClientBtnED(ActionEvent event)  throws SQLException {
        updateClientBtnED.getScene().getWindow().hide();
        SaleManagementUtil.loadWindow(getClass().getResource("/tourCheckPage.fxml"), "Onvacation - Reservation", null);
       /* //record reservation
